            ...
            <form method="POST" action="{{ route('orgSchedule.updateSchedule', ['schedule' => $data->scheduleID]) }}">
                ...
                <div class="modal-body">
                    <div class="form-group row p-2">
                        ...
                        <div class="col-md-9">
                            <input id="scheduleName" type="text" class="form-control @error('scheduleName') is-invalid @enderror" name="scheduleName" value="{{ $data->scheduleName }}" required>
                        </div>
                    ...
                    <div class="form-group row p-2">
                        ...
                        <div class="col-md-9">
                            <div class="md-form">
                                <input class="date form-control @error('scheduleDateStart') is-invalid @enderror" type="text" placeholder="Select a date" id="scheduleDateStart" name="scheduleDateStart" data-bs-target=".date" value="{{ $data->scheduleDateStart }}" required>
                            </div>
                    ...
                    <div class="form-group row p-2">
                        ...
                        <div class="col-md-9">
                            <div class="md-form">
                                <input class="date form-control @error('scheduleDateEnd') is-invalid @enderror" type="text" placeholder="Select a date" id="scheduleDateEnd" name="scheduleDateEnd" data-bs-target=".date" value="{{ $data->scheduleDateEnd }}" required>
                            </div>
                            <script type="text/javascript">
                                $('.date').datetimepicker({  
                                    defaultDate: new Date(),
