...
=======
                ...
                <div class="input-group">
                    <input type="text" name="titleInput" id="titleInput" class="form-control @error('titleInput') is-invalid @enderror" placeholder="Title *" aria-label="Title" value="{{ old('titleInput') }}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="descriptionInput" class="form-control @error('descriptionInput') is-invalid @enderror" id="descriptionInput" name="description" placeholder="Enter your message here (max 1500 words)" maxlength="1500" style="resize: none; height: 500px" value="{{ old('descriptionInput') }}"  required></textarea>
...
>>>>>>> 6a99d6e7ccbf59f0b8a6f90af48d70eeb39e1143
    </div>
</div>
