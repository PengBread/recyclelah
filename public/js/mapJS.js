...
function initMap() {
  ...
  var longitude = parseFloat(document.getElementById("lng").value); // const contentString =
  // '<form method="" action="">' +
...
function schedulePointers() {
  ...
  var longitude;
  var marker;
  var contentString = '<form method="" action="">' + '@csrf' + // "@method('put')" +
  '<div id="content">' + "<p><b>Latitude: 1000, Longitude: -1111</b></p>" + '<div id="bodyContent">' + "Name: John Doe <br>" + "Phone No: 0124669989 <br>" + "Address: Penang, Malaysia" + "</div>" + '<div style="text-align: end; padding-top: 8px;">' + '<button type="submit" id="collectedBtn" class="btn-primary">COLLECTED</button>' + "</div>" + "</div>" + "</form>";
  var map = new google.maps.Map(document.getElementById('googleMap'), {
    center: {
      lat: 100.3287506,
